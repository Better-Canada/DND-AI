...
class StateTracker:
	...
	def GetPossibleEntries(self):
		...
		# e.g. slot = category and value = greeting
	...
	def GetStateRepresentation(self):
		...
		for key in self.filledSlots:
			if key in self.filledSlotsDictionary:
	...
	# Takes a list and returns its values as keys and their indices as values in a dictionary
